document.addEventListener("DOMContentLoaded", function () {
  document
    .querySelector("#btnSwapInstructorRegister")
    .addEventListener("click", function () {
      document.querySelector("#frmInstructorLogin").classList.add("d-none");
      document
        .querySelector("#frmInstructorRegister")
        .classList.remove("d-none");
    });
  document
    .querySelector("#btnSwapInstructorLogin")
    .addEventListener("click", function () {
  ...
  document
    .querySelector("#btnSwapInstructorLoginFromStudentLogin")
    .addEventListener("click", function () {
      document.querySelector("#frmStudentLogin").classList.add("d-none");
      document.querySelector("#frmInstructorLogin").classList.remove("d-none");
    });
  ...
  document
    .querySelector("#btnInstructorRegister")
    .addEventListener("click", () => {
      let strFirstName = document
        .querySelector("#txtInstructorFirstName")
        .value.trim();
      let strLastName = document
        .querySelector("#txtInstructorLastName")
        .value.trim();
      let strEmail = document
        .querySelector("#txtInstructorRegisterEmail")
        .value.trim();
      let strPassword = document
        .querySelector("#txtInstructorRegisterPassword")
        .value.trim();
      ...
      if (!strFirstName || !strLastName) {
        blnError = true;
        strMessage +=
          "<p class='mb-0 mt-0'>First and Last Name are required.</p>";
      }

      if (!regEmail.test(strEmail) || !strEmail.endsWith(".edu")) {
        blnError = true;
        strMessage +=
          "<p class='mb-0 mt-0'>Invalid email. Instructors must use a .edu email.</p>";
      }

      if (!regPassword.test(strPassword)) {
        blnError = true;
        strMessage +=
          "<p class='mb-0 mt-0'>Password must be at least 8 characters, include uppercase, lowercase, a number, and a special character.</p>";
      }
  ...
  document
    .querySelector("#btnStudentRegister")
    .addEventListener("click", () => {
      let strFirstName = document
      ...
      let strEmail = document
        ...
        .value.trim();
      let strMobile = document
        .querySelector("#txtStudentRegisterMobile")
        .value.trim();
      let strDiscord = document
        .querySelector("#txtStudentRegisterDiscord")
        .value.trim();
      let strPassword = document
      ...
      if (strDiscord && !regDiscord.test(strDiscord)) {
        blnError = true;
        strMessage +=
          "<p class='mb-0 mt-0'>Invalid Discord ID. Format: username#1234</p>";
      }
  ...
  document
    .querySelector("#btnInstructorLogin")
    .addEventListener("click", () => {
      let strEmail = document
        .querySelector("#txtInstructorLoginEmail")
        .value.trim();
      let strPassword = document
        .querySelector("#txtInstructorLoginPassword")
        .value.trim();
